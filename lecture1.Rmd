...
## Why surveys: A stated objective
...
$$ \small {\text Cov} (X, Y) = E [ (X-\mu_x ) (Y - \mu_y) ] = {\text Cov} (Y,X)$$ and $V(X) = Cov(X,X)$.
...
We also hope variance is small: $V(t_s) = E[ (t_s - E[t_s])^2]$ is small.
