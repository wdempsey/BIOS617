...
- 75% Quartile: 94
- Max: 100
- Given the current semester, I will not assign extra credit.
- There will be a curve on the midterm.  Exact curve will be announced soon.
...
Start with $v(\tilde y_1)$, repalcing unknowns $Y_i$ with their (unbiased) sample estimates $\hat Y_i$:
$$
