...
* Split cell data into strata of 18-24 ($P_1 = `r round(P1,3)`$\%), 25-44 ($P_2 = `r round(P1,3)`$\%), and 45+ ($P_3 = `r round(P3,3)`$\%)
...
* PS estimates are `r round(cellest,2)` for cell only data and `r round(llest,2)`
