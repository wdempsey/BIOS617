...
- *Population* denotes the aggregate from which the sample is chosen
  ...
  + All current Ann Arbor residents
...
&= \int x \left[ \int f_{xy} (x,y) dy \right] dx + \int y \left[ \int f_{xy} (x,y) dx \right] dy
\end{aligned}
$$
...
## Your first JITT (first 10-minutes of next class, discuss in small) 
...
- Be ready to describe the results.
