...
* But raking if equivalent to an ANOVA main effects-only model that assumes independence between age and gender:
...
* The idea is to recalibrate the survey weights $d_i$ to new values $w_i$
  + where $w_i$ satisfy $\sum_i w_i x_i = X$ where 
