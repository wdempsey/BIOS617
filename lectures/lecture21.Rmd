...
* I will post HW 4 solutions today/tomorrow
...
```
* Today: 2 phase (not stage!) sampling
* Tomorrow: Calibration + Big Data paradox discussion 
...
Plugging 
$$\nu_h = S_h \left[ \frac{c^\prime}{c_h (S^2 - \sum_h P_h S_h^2)} \right]$$ 
into $C^\star V$, we obtain
$$
V \approx \frac{1}{C^\star} \left[ \sum_h P_h S_h \sqrt{c_h} +
(S^2 - \sum_h P_h S_h^2 )^{1/2} \sqrt{ c^\prime} \right]
$$
