...
psbary = bary_female * (1-census_female) + bary_female*census_female
...
$$
\bar y_s - \bar Y = \frac{N}{nM} \sum_{h=1}^M \sum_{i=1}^{n_h} z_{hi} = \frac{N \bar z}{M}
$$
...
library(knitr)
include_graphics("./figs/l4_table2.png") # place holder
```
...
The deff for equal-size cluser sampling is given by
