...
&= E\left [-\frac{\bar u (\bar x - \bar X)}{s_x^2} = -\frac{(\bar u - \bar U) (\bar x - \bar X)}{s_x^2} \right]\\
...
lurking here: bias goes to 0 as the relationship between Y i
and X i becomes linear, and variance is reduced as the
correlation (linear regression slope if Y i and X i are linearly
