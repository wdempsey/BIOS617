...
* $d_i = 100$ for all $i$ except the bridge which has $d_i = 100$.  Stationary distribution is approximately uniform with weights $99/(198*99 + 2*100) = `r round(99/(198*99 + 2*100), 4)`$ and $100/(198*99 + 2*100) = `r round(100/(198*99 + 2*100), 4)`$
* Waiting time to get to brige is Geometric with $p=1/99$, and then there is a chance to cross or not cross with probabilty $1/100$.  So let $H_l \sim Geom(1/99)$ and $C_l \sim Bern(1/100)$ be iid for $l=1,\ldots$ then the holding time until crossing is given by
$$
\begin{aligned}
...
* The expectation of $H_l$ is $99$ and of $C_l$ is $1/100$.
* So we have
...
= & 99 \left( 1 + (1-1/101) + (1-1/101)^2 + \ldots \right) \\
= & 99 \sum_{l=0}^\infty (99/100)^l \\
= & 99 \times \frac{1}{1-99/100} = 99 \times 100 = `r 99 * 100`
\end{aligned}
$$
